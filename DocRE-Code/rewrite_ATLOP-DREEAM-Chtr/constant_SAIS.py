...
path = ("TSER_Logsumexp{}{}_TASK_ET{}_three{}_cls{}_bilinear{}_reduced{}_relation{}_extractor{}_seed{}_Relation_Seploss{}"
        "_Relation_loss{}").format(evi_lambda, TSER_Logsumexp, TASK_ET, three_atten, use_cls_info, use_bilinear, reduced_dim,
                                                relation_dim, extractor_dim, seed, Relation_Seploss, Relation_loss
                                                )
save_path = "./Save/" + path
