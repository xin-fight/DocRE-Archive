...
class DocREModel(nn.Module):
    ...
    def get_Primitive_hrt(self, sequence_output, attention, entity_pos, hts, offset):
    ...
    def forward(self,
        ...
        hs, rs, ts, doc_attn, rels_per_batch = self.get_Primitive_hrt(sequence_output, attention, entity_pos, hts, offset)
        hs = hs.unsqueeze(1)
        rs = rs.unsqueeze(1)
        ts = ts.unsqueeze(1)
